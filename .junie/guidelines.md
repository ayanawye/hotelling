...
Данный документ определяет стандарты разработки для проекта **HotellingIO**. Следование этим правилам обеспечивает чистоту кода, масштабируемость и единый стиль во всем приложении.
...
*   **Типизация:** Избегайте `any`. Описывайте интерфейсы в папке `model/types.ts` соответствующей сущности.
