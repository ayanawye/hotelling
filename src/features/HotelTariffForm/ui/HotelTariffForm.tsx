...
import styles from './HotelTariffForm.module.scss';
...
interface OrganizationFormProps {
  initialValues?: ITariff;
  onSuccess?: () => void;
  onCancel?: () => void;
}

export const HotelTariffForm: React.FC<OrganizationFormProps> = ({
  initialValues,
  onSuccess,
  onCancel,
}) => {
  ...
  const [patchTariff, { isLoading: isUpdating }] = usePatchTariffMutation();
